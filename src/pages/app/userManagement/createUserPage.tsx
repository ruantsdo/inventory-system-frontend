...
import { CreateUserFinalStep } from "./createNewUserSteps/createUserFinalStep";
import { CreateUserFirstStep } from "./createNewUserSteps/createUserFirstStep";
import { CreateUserSecondStep } from "./createNewUserSteps/createUserSecondStep";

const createUserFullSchema = createUserStep1Schema.and(createUserStep2Schema);

function buildPayload(form: CreateUserFormState): CreateUserPayload {
...
export function CreateUserPage() {
  ...
  const methods = useForm<CreateUserFormState>({
    resolver: zodResolver(createUserFullSchema as any),
  ...
  return (
    <FormProvider {...methods}>
      ...
      <Container size="lg">
        ...
        <Box mb="xl">
          {activeStep === 0 && <CreateUserFirstStep />}
          {activeStep === 1 && <CreateUserSecondStep />}
          {activeStep === 2 && (
            <CreateUserFinalStep payload={buildPayload(getValues())} allRoles={allRoles} />
          )}
        </Box>
